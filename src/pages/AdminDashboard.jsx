...
const AdminDashboard = () => {
  ...
  const handleInitializeStaffData = async () => {
    try {
      ...
      await initializeStaffData();
      await fetchStaffData(); // Refresh the staff data after initialization
      alert('Staff data has been successfully initialized!');
    } catch (error) {
      console.error('Error initializing staff data:', error);
    ...
    <div className={`${styles.dashboard} ${isDarkMode ? styles.darkMode : ''}`}>
      <div className={styles.header}>
        ...
        <div className={styles.headerButtons}>
          ...
          >
            {initializingStaff ? 'Initializing...' : 'Initialize Staff Data'}
          </button>
